...
import akkastore.JsonSupport.{AkkaStoreSet, AkkaStoreGet, AkkaStoreRemove}
import org.scalatest.concurrent.ScalaFutures
import org.scalatest.{Matchers, WordSpec}

class AkkaStoreREST extends WordSpec with Matchers with ScalatestRouteTest with ScalaFutures with JsonSupport.JsonSupport {
